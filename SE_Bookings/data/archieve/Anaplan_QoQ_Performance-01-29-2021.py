...
Export the Anaplan report
Run this script to load the data into SalesOps_DM
...
#target = 'G:\\My Drive\\Sync Laptop on Google Drive\\workspace\\SE_Performance\\DISPLAY_ QoQ Historical Performance M1 - 01.13.2021.xlsx'
#M2_target = 'G:\\My Drive\\Sync Laptop on Google Drive\\workspace\\SE_Performance\\DISPLAY_ QoQ Historical Performance M2 - 01.13.2021.xlsx'
#target = 'G:\\My Drive\\Sync Laptop on Google Drive\\workspace\\SE_Performance\\DISPLAY_ QoQ Historical Performance M1 - 02.01.2021.xlsx'
#M2_target = 'G:\\My Drive\\Sync Laptop on Google Drive\\workspace\\SE_Performance\\DISPLAY_ QoQ Historical Performance M2 - 02.01.2021.xlsx'
#target = 'G:\\My Drive\\Sync Laptop on Google Drive\\workspace\\SE_Performance\\DISPLAY_ QoQ Historical Performance M1 - 02.02.2021.xlsx'
#M2_target = 'G:\\My Drive\\Sync Laptop on Google Drive\\workspace\\SE_Performance\\DISPLAY_ QoQ Historical Performance M2 - 02.02.2021.xlsx'
# Downloaded on 02.06.2021 - Anaplan stated file is 02/02/2021 Prem
#target = 'G:\\My Drive\\Sync Laptop on Google Drive\\workspace\\SE_Performance\\DISPLAY_ QoQ Historical Performance M1 - 02.06.2021.xlsx'
#M2_target = 'G:\\My Drive\\Sync Laptop on Google Drive\\workspace\\SE_Performance\\DISPLAY_ QoQ Historical Performance M2 - 02.06.2021.xlsx'
#target = 'G:\\My Drive\\Sync Laptop on Google Drive\\workspace\\SE_Performance\\DISPLAY_ QoQ Historical Performance M1 - 02.11.2021.xlsx'
#M2_target = 'G:\\My Drive\\Sync Laptop on Google Drive\\workspace\\SE_Performance\\DISPLAY_ QoQ Historical Performance M2 - 02.11.2021.xlsx'
target = 'G:\\My Drive\\Sync Laptop on Google Drive\\workspace\\SE_Performance\\DISPLAY_ QoQ Historical Performance M1 - 02.16.2021 - FY21 Final.xlsx'
M2_target = 'G:\\My Drive\\Sync Laptop on Google Drive\\workspace\\SE_Performance\\DISPLAY_ QoQ Historical Performance M2 - 02.16.2021 - FY21 Final.xlsx'

report_date = '2021-02-16'
...
output['CQ_YtD_Achievement'] = output['2021_Q1_Actual'] + output['2021_Q2_Actual'] + output['2021_Q3_Actual'] + output['2021_Q4_Actual']
output['CQ_YtD_Quota'] = output['2021_Q1_Quota'] + output['2021_Q2_Quota'] + output['2021_Q3_Quota'] + output['2021_Q4_Quota']

quota_col = ['2021_Q1_Quota', '2021_Q2_Quota','2021_Q3_Quota','2021_Q4_Quota','2021_CQ_Quota']
achievement_col = ['2021_Q1_Actual', '2021_Q2_Actual', '2021_Q3_Actual','2021_Q4_Actual','2021_CQ_QtD_Achievement']
attainment_col = ['2021_Q1_Attn', '2021_Q2_Attn', '2021_Q3_Attn','2021_Q4_Attn']
...
CQ_col = ['EmployeeID', 'CQ_IncrementBooking', 'CQ_AdvStage', 'CQ_ProjectedAchievement', 'CQ_Projected_Attn', 'CQ_YtD_Achievement', 'CQ_YtD_Quota']
...
prep_file = pd.read_excel(cfg.sup_folder + supplement, sheet_name='Anaplan_Performance', skiprows=3, header=0, usecols = "AC:AG")
prep_file = prep_file[prep_file.Include == 1.0]
read_cols = ",".join(list(prep_file.Column))
new_names = list(prep_file.NewName)
data_type = dict(zip(prep_file.NewName, prep_file.DataType))
...
M2_output['CQ_YtD_Achievement'] = M2_output['2021_Q1_Actual'] + M2_output['2021_Q2_Actual'] + M2_output['2021_Q3_Actual'] + M2_output['2021_Q4_Actual'] + M2_output['2021_CQ_QtD_Achievement']
M2_output['CQ_YtD_Quota'] = M2_output['2021_Q1_Quota'] + M2_output['2021_Q2_Quota'] + M2_output['2021_Q3_Quota'] + M2_output['2021_Q4_Quota']

M2_quota_col = ['2021_Q1_Quota', '2021_Q2_Quota', '2021_Q3_Quota', '2021_Q4_Quota','2021_CQ_Quota']
M2_achievement_col = ['2021_Q1_Actual', '2021_Q2_Actual', '2021_Q3_Actual','2021_Q4_Actual','2021_CQ_QtD_Achievement']
M2_attainment_col = ['2021_Q1_Attn', '2021_Q2_Attn','2021_Q3_Attn','2021_Q4_Attn', '2021_CQ_Attn']
...
CQ_col = ['EmployeeID', 'CQ_YtD_Achievement', 'CQ_YtD_Quota']
