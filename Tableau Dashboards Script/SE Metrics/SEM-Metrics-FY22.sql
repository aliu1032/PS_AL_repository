...
#Deal_Split as (
			...
			where Oppt.CloseDate >= '2021-02-03' -- and Oppt.CloseDate < '2021-02-01'
...
#SE_Coverage as (
	Select Name, EmployeeID, Territory_ID
  	  from SalesOps_DM.dbo.Coverage_assignment_byName_FY22
),
...
#Geo_M1_Quota as (
	...
	from SalesOps_DM.dbo.Territory_Quota_FY22
...
#Geo_Quota_Wide as (
		...
		from (Select distinct(Territory_ID) from SalesOps_DM.dbo.Territory_Quota_FY22 where Level = 'Territory' and Period = 'FY'
			  UNION
...
-----	left join #SE_Coverage on #SE_Coverage.EmployeeID = SE_Oppt_Owner.EmployeeNumber
