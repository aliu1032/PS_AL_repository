...
#StackRank_FY21 as (
	select Report_Date, Name, EmployeeID, FiscalYear, Measure, CQ_YtD_Achievement [M1_YtD_Achievement], CQ_YtD_Quota [M1_Annual_Quota]
	from SalesOps_DM.dbo.StackRank
	where Measure = 'M1' and Period = 'CQ'
)
	  ...
	  as [Relative_closeqtr]
		...
		from (	  
			...
			--	, [Final].[District_Permission]
				...
				, [Final].[M1_YtD_Achievement]
				, [Final].[M1_Annual_Quota]			
			...
			*/
					...
					, #StackRank_FY21.[M1_YtD_Achievement]
					, #StackRank_FY21.[M1_Annual_Quota]
				...
				left join #StackRank_FY21 on #StackRank_FY21.EmployeeId = SE_Oppt_Owner.EmployeeNumber
