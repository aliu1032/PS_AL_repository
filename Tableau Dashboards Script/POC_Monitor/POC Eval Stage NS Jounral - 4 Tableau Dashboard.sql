...
set @Lookup_Oppt_Id = '0064W00000vriiuQAA'
;
...
#Outbound_Item_Fulfill as (
	select TrnsO.SFDC_SYNC_ID, F.Created_From_ID
		 ...
		 , TrnsO.TranId [Ship TO#], TrnsO.Status, TrnsO.Memo [Ship TO Memo]
...
#NS_POC_TransferOrder_Ship as (
	select OIF.SFDC_SYNC_ID
		 ...
		 , OIF.[Ship TO#] [TranID], OIF.Status, OIF.[Ship TO Memo] [Memo]
...
#Inbound_Item_Fulfill as (
	select TrnsO.SFDC_SYNC_ID, F.Created_From_ID
		 , FL.Item_ID
		 , Inv.inventory_number
		 , TrnsO.TranId [Return TO#], TrnsO.Status, TrnsO.Memo [Return TO Memo]
...
#NS_POC_TransferOrder_Return as (
	select RIF.SFDC_SYNC_ID
		 ...
		 , RIF.[Return TO#] [TranID],RIF.Status, RIF.[Return TO Memo] [Memo]
...
#SO_Item_Fulfill as (
	select TrnsO.SFDC_SYNC_ID
		 ...
		 , TrnsO.TranId [TranID],TrnsO.Status, TrnsO.Memo [Memo]
...
Select a.SFDC_SYNC_ID [Oppt_Id]
	  , Prod.*
	  , a.[Serial Number], a.[Type], a.Status, a.[TranID], a.[Memo]
